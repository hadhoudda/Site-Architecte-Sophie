...
/**
 * fonction d'affichage message d'erreur
...
const validEmail = (inputEmail) => {
    ...
    if(testEmail){
        small.textContent = 'adresse email valide'
        small.classList.remove('text-no-valide')
        small.classList.add('text-valide')
        return true
    }
    else{
        small.textContent = 'Adresse Email Non valide'
...
const validPassword = (inputPassword) => {
    ...
    if(valide){
        small.textContent = 'mot de passe valide'
        small.classList.remove('text-no-valide')
        small.classList.add('text-valide')
        return true;
    }
